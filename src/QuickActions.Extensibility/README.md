# Quick Actions: Extensibility Framework
...
The `BadEcho.QuickActions.Extensibility` library is a framework for creating code action plugins for Quick Actions. To provide a code action, reference this library and export an implementation of the `IAction` interface.

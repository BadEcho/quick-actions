...
This repo contains the code for QuickActions, a Bad Echo application. QuickActions allows you to assign tasks of varying complexity to keyboard shortcuts.

Other tools exist out there which fulfill the same purpose, such as *AutoHotKey*; however, I created this for my personal use as a way to easily execute my own types of task code. If others get some use out of it, or learn something from the code, that's just fine by me.
